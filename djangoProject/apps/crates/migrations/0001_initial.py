...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('crate_type', models.CharField(choices=[('materials', 'Materials Crate'), ('blueprint', 'Blueprint Crate'), ('rare_blueprint', 'Rare Blueprint Crate'), ('special', 'Special Crate'), ('mystery', 'Mystery Crate'), ('epic', 'Epic Crate'), ('legendary', 'Legendary Crate'), ('eco', 'Eco Crate'), ('advanced_materials', 'Advanced Materials Crate'), ('farm_currency', 'Farm Currency Crate'), ('plant_seed', 'Plant Seed Crate'), ('rare_seed', 'Rare Herb Crate'), ('exotic_seed', 'Exotic Flora Crate'), ('mythical_seed', 'Mythical Garden Crate'), ('legendary_seed', 'Legendary Botanical Crate')], default='materials', max_length=50)),
